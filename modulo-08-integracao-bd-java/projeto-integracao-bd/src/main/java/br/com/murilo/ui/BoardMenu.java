...
import br.com.murilo.service.BoardColumnQueryService;
import br.com.murilo.service.BoardQueryService;
import br.com.murilo.service.CardQueryService;
import br.com.murilo.service.CardService;
    ...
    private void showBoard() throws SQLException {
        try (var connection = getConnection()) {
            ...
            optional.ifPresent(b -> {
                ...
                b.columns().forEach(c ->
                        System.out.printf("Coluna [%s] tipo: [%s] com %s cards%n",
        ...
        try (var connection = getConnection()) {
            ...
            column.ifPresent(co -> {
                ...
                co.getCards().forEach(ca ->
                        System.out.printf("Card %s - %s%nDescrição: %s%n",
